...
class IntendedSequenceTest {
    ...
    void saveContentMetadataForFilm() throws Exception {
        ...
        var filmingGroup = FilmingGroup.builder().director(meta.creator).actors(List.of(meta.creator)).build();
        ...
        mockMvc
                ...
                .andExpect(jsonPath("$.subGenres", contains(is("comedy"), is("drama"))))
                ...
                .andDo(
                        result -> {
                            ContentMetadata savedMetadata = objectMapper.readValue(
                                    result.getResponse().getContentAsString(), new TypeReference<>() {
                                    });
