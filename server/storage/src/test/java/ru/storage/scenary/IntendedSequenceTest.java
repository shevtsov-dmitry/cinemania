...
class IntendedSequenceTest {
        ...
        mockMvc
                .perform(
                        multipart(serverUrl + "/api/v0/metadata/content-creators/user-pics/upload")
                                .file(multipartFile)
                                .param("position", Position.ACTOR.stringValue))
                ...
                .andExpect(jsonPath("$.position", notNullValue()))
                .andDo(
                        result -> {
    ...
    void requestForSavedImage_andTryToParseIt() throws Exception {
        ...
        mockMvc
                .perform(
                        get(
                                serverUrl + "/api/v0/metadata/content-creators/user-pics/{position}/{id}",
    ...
    void saveContentMetadataForFilm() throws Exception {
        ...
        var metadata = ContentMetadataDTO.builder()
                ...
                .standaloneVideoShow(
                        new MediaFileInfo(VIDEO_FILE.getName(), "video/mp4", VIDEO_FILE.length()))
