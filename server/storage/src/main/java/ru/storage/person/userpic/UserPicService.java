...
public class UserPicService {
    ...
    /**
     * Uploads a new image to the specified storage folder and associates it with
     * the given user pic
     * entity.
     *
     ...
     * @throws IllegalArgumentException when the multipart file is not an image
     *                                  file.
     * @throws S3Exception              when an error occurs during the upload
     *                                  process.
     */
     ...
     * @return resouce containing single byte array with the delimiter in between
     *         the images.
     * @throws S3Exception            when an error occurs during the retrieval
     *                                process
     ...
     * @param personCategory the category of the user pic (e.g., USER)
     * @param ids            a comma-separated string of content metadata IDs
     * @throws S3Exception when an error occurs during the deletion process from S3
     *                     storage
     */
