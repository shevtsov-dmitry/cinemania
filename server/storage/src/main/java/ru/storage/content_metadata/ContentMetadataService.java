...
public class ContentMetadataService {
    ...
    public ContentMetadataService(ContentMetadataRepo contentMetadataRepo, VideoService videoService, PosterService posterService) {
    ...
    public ContentMetadata saveMetadata(VideoInfoParts metadataObjects) {
        ...
        contentMetadata.setVideo(savedVideoMetadata);
    ...
    public void removeContent(String contentId) {
        var contentDetails = contentMetadataRepo.findById(contentId)
