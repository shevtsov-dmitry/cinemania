...
public class PosterController {
     ...
     *         <ul>
     *         <li>201 (CREATED)
     *         <li>400 (BAD_REQUEST) with the cause header "Message" when invalid
     *         args
     *         <li>500 (INTERNAL_SERVER_ERROR) with the cause header "Message" when
     *         image wasn't saved
     ...
     *         in between the binary items
     *         <li>400 (BAD_REQUEST) with the cause header "Message" when content
     *         metadata IDs are invalid
     *         <li>404 (NOT_FOUND) with the cause header "Message" when no matching
     *         items are found
     *         <li>500 (INTERNAL_SERVER_ERROR) with the cause header "Message" when
     *         an error occurs
     *         </ul>
     ...
     *          <li>401 (BAD_REQUEST) with the cause header "Message" when param
     *          format is not like
     *          mongodb id standard
     *          <li>500 (INTERNAL_SERVER_ERROR) with the cause header "Message" when
     *          error performing
