...
public class S3GeneralOperations {
     ...
     */
    public static Resource getBinariesByIds(String s3Folder, String ids) {
        List<byte[]> binaryItemsList =
                S3GeneralOperations.findMatchedIds(s3Folder, parseIds(ids)).stream()
     ...
     * @throws NoSuchElementException when no matches are found for the provided ids
     */
//  public static Map<String, byte[]> getMapsByIds(String s3Folder, String ids) {
