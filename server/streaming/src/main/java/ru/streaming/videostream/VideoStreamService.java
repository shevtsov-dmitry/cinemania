...
public class VideoStreamService {
    ...
    public static final String S3_FOLDER = "videos";
    ...
    void getHlsPlaylist(HttpServletResponse response, String videoType, String id) {
        String objectKey = S3_FOLDER + "/" + videoType + "/" + id + "/index.m3u8";
        ...
        try {
            ...
            String baseUrl = "http://localhost:8443/api/v1/stream/" + videoType + "/" + id + "/chunk/";
