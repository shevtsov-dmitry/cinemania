...
const FormAddCreator = () => {
    ...
    const [operationStatus, setOperationStatus] = useState<OperationStatus | undefined>();
    ...
    async function handleSubmit(e: FormEvent) {
        ...
        const res = await fetch(Constants.STORAGE_URL + "/api/v0/metadata/content-creators", {
            method: "POST",
            headers: {
    ...
    async function uploadImage(): Promise<UserPic | undefined> {
        ...
        if (file) {
            ...
            const res = await fetch(
                Constants.STORAGE_URL + "/api/v0/metadata/content-creators/user-pics/upload",
                {
                    method: "POST",
                    body: formData,
                }
