      ...
      >
        <ul className="w-fit">
          ...
          <li id="country">
            ...
            />
            <div className="typingSuggestions">{countrySuggestionsDOM}</div>
          </li>
          <li id="releaseDate">
            <p>Дата релиза</p>
            <input
          ...
          <li id="mainGenre">
            ...
            />
            <div className="typingSuggestions">{mainGenreSuggestionsDOM}</div>
          </li>
          <li id="subGenres">
            <p>Поджанры</p>
            <input
              ...
              onChange={() => {}}
            />
            <div className="typingSuggestions">{subGenresSuggestionsDOM}</div>
          </li>
