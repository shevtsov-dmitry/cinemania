...
let trailerUrl =
    `${Constants.STREAMING_SERVER_URL}/api/v1/stream/67d47489eeda036a76103a6e/playlist`;

trailerUrl =
    `${Constants.STREAMING_SERVER_URL}/api/v1/stream/123/playlist`;
...
const Home = (): ReactElement => {
    ...
    return (
        ...
        >
            <Text className={"text-5xl font-bold"}>Player</Text>
